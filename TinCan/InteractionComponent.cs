...
namespace TinCan
{
    public class InteractionComponent : JsonModel
    {
        ...
        public InteractionComponent(StringOfJSON stringOfJson) : this(stringOfJson.toJObject())
        {
        }

        public InteractionComponent(JObject jObject)
        {
            if (jObject["id"] != null)
            {
            ...
            {
                description = (LanguageMap)jObject.Value<JObject>("description");
            }
        }
